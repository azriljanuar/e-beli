                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end space-x-1">
                                ...
                                <a href="<?= base_url('/expenses/delete/'.$expense['id']) ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')" class="p-2 text-red-500 hover:bg-red-50 rounded-lg transition-all" title="Hapus">
